...
public class S20190010163_AssignMG3 {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("The First Student Grade on Exam One is " + s1.getGrade(0));
        System.out.println("The Second Student Name is " + s2.getName());
        System.out.println("The Second Student Grade on Exam One is " + s2.getGrade(0));
